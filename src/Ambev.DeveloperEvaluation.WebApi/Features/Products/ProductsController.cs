...
public class ProductsController : BaseController
{
    ...
    /// <returns>Success response with data product was created</returns>
    [HttpPost]
    [ProducesResponseType(typeof(ApiResponseWithData<CreateProductResponse>), StatusCodes.Status201Created)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status400BadRequest)]
    public async Task<IActionResult> CreateProductaAsync([FromBody] CreateProductRequest request, CancellationToken cancellationToken)
    {
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Success response with data product was deleted</returns>
    [HttpDelete("{id}")]
